...
Присоединяйтесь к счастливчикам!
    ...
    def run(self):
        ...
        while True:
            ...
            print(f"{Colors.YELLOW}ℹ️  Это ОФЛАЙН-генератор учебных шаблонов. Письма "
                  f"НЕ отправляются — инструмент для тренингов по awareness, "
                  f"распознавания фишинга и анализа приёмов.{Colors.END}\n")
